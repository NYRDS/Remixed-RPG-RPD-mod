   ...
   if lvl == nil then
    lvl = Count.lvl
        ...
        return {
            ...
            info          = "Удары оружием и голыми руками становятся способны нанести урон не только плоти, но и душе. Дополнительный урон наносится каждые два удара. Дополнительный урон увеличивается с ростом \"магической силы\" и уровня навыка, длительность растёт с уровнем навыка ",
